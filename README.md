...
Screenshots pending — add to /public/screenshots/ and reference them here:

hero.png — landing hero with CTA
services.png — services catalog
mobile.png — mobile-first responsive view
contact.png — contact / booking section
