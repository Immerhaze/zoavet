...
export const SERVICE_BANNER = [
...

  {
    title: "Urgencias 24/7",
    description:
      "Estamos disponibles las 24 horas para ofrecer atención inmediata y especializada. Nuestro equipo altamente capacitado y nuestra tecnología de última generación garantizan una respuesta rápida y efectiva. Realizamos valoraciones ágiles, apertura de historias clínicas y resolvemos problemas con precisión. Si tienes una remisión médica, gestionamos los análisis y enviamos los resultados a tu veterinario.",
  },
...

  {
    title: "Vacunación",
    description:
      "Las vacunas son esenciales para proteger a tu mascota de enfermedades contagiosas. Nuestro equipo crea un plan de vacunación personalizado según la especie, edad, estilo de vida y riesgos de tu compañero, asegurando protección contra enfermedades graves.",
  },
...

  {
    title: "Hospitalización",
    description:
      "Ofrecemos hospitalización integral para pacientes que necesitan atención y monitoreo continuo. Realizamos exámenes clínicos completos, supervisamos a pacientes críticos y administramos tratamientos personalizados para asegurar su bienestar.",
  },
...

  {
    title: "Ecografía",
    description:
      "Realizamos ecografías para una evaluación precisa y no invasiva del estado de salud de tu mascota. Nuestra tecnología avanzada permite una visualización detallada de los órganos internos para diagnosticar y tratar afecciones con eficacia.",
  },
  ...
  {
    title: "Anestesia Inhalada",
    description:
      "Ofrecemos anestesia inhalada para procedimientos quirúrgicos, garantizando mayor seguridad, especialmente para pacientes con condiciones preexistentes, críticos, de edad avanzada o gestantes.",
  },
